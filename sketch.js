...
function preload() {
  ...
  alan1Stand = loadAnimation("../Alan/Idle__000.png","../Alan/Idle__001.png");
  alan1Run = loadAnimation("Alan/Run__000.png","Alan/Run__001.png","Alan/Run__002.png","Alan/Run__003.png","Alan/Run__004.png","Alan/Run__005.png","Alan/Run__006.png");
  alan1Jump = loadAnimation("Alan/Jump__000.png","Alan/Jump__001.png","Alan/Jump__002.png","Alan/Jump__003.png","Alan/Jump__004.png","Alan/Jump__005.png","Alan/Jump__006.png","Alan/Jump__007.png","Alan/Jump__008.png","Alan/Jump__009.png");
  alan1Attack = loadAnimation("Alan/Attack__000.png","Alan/Attack__001.png","Alan/Attack__002.png","Alan/Attack__003.png","Alan/Attack__004.png","Alan/Attack__005.png","Alan/Attack__006.png","Alan/Attack__007.png","Alan/Attack__008.png","Alan/Attack__009.png");
  alan1Dead = loadAnimation("Alan/Dead__000.png","Alan/Dead__001.png","Alan/Dead__002.png","Alan/Dead__003.png","Alan/Dead__004.png","Alan/Dead__005.png","Alan/Dead__006.png","Alan/Dead__007.png","Alan/Dead__008.png","Alan/Dead__009.png");
...
function setup() {
  ...
  alan1.addAnimation("stand",alan1Stand);
  alan1.addAnimation("jump", alan1Jump);
  alan1.addAnimation("run",alan1Run);
  alan1.addAnimation("attack",alan1Attack);
  alan1.scale = 0.15;
...
function draw() {
  ...
  if(gameState === "level2") {   
      ...
      if(keyDown("l")) {
        alan1.changeAnimation("attack",alanAttack);
      } else {
        alan1.changeAnimation("stand",alanStand);
      }
